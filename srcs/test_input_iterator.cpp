...
inline static int	__test_constructor(void)
{
	...
	try
	{
		// Pointer constructor
		{
			...
			{
				ft::input_iterator<int>	it(&g_int[idx]);
		...
		// Copy constructor
		{
			for (idx = 0U ; idx < g_int_size ; ++idx)
			{
				ft::input_iterator<int>	it0(&g_int[idx]);
...
inline static int	__test_operator_assign(void)
{
	...
	try
	{
		...
		{
			ft::input_iterator<std::string>	it1(&g_string[idx]);
...
inline static int	__test_operator_equal(void)
{
	...
	try
	{
		...
		{
			ft::input_iterator<int>	it0(&g_int[idx0]);

			for (idx1 = 0U ; idx1 < g_int_size ; ++idx1)
			{
				ft::input_iterator<int>	it1(&g_int[idx1]);
...
inline static int	__test_operator_dereference(void)
{
	...
	try
	{
		...
		{
			ft::input_iterator<t_hint>	it(&g_hint[idx]);
...
inline static int	__test_operator_maddress(void)
{
	...
	try
	{
		...
		{
			ft::input_iterator<std::pair<int, char> >	it(&g_pair[idx]);
...
inline static int	__test_operator_increment(void)
{
	...
	try
	{
		...
		{
			ft::input_iterator<t_luint>	it(&g_luint[0]);
