...
public:
    ...
    typedef typename container_type::ValueType       ValueType;
...
public:
     ...
     */
    explicit stack(
        container_type const &ctnr = container_type()
    )
    : _ctnr(ctnr)
    {}
     ...
     *
     * @param	inner The value to push.
     */
    void push(
        const_reference inner
    )
    {
        _ctnr.push_back(inner);
    }
    ...
    /**
     * friend keyword allows non-member functions to access private and
...
bool operator==(
    stack<T, Container> const &lhs, stack<T, Container> const &rhs
)
{
...
/**
 * @brief	Check if two stack are strictly lexicographicaly
 * reverse-ordered.
 *
 * @tparam	T The type of the elements of the stacks.
 * @tparam	Container The type of the underlying container of the stacks.
...
/**
 * @brief	Check if two stack are lexicographicaly reverse-ordered or
 * equivalent.
 *
 * @tparam	T The type of the elements of the stacks.
 * @tparam	Container The type of the underlying container of the stacks.
